...
**Caretta X** is licensed to You (End-User) by Mehmet Can Bil Karamalli, located and registered at Beykoz, Istanbul, Turkey ('Licensor'), for use only under the terms of this License Agreement.
...
The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance, and support thereof. Mehmet Can Bil Karamalli, not the Services, is solely responsible for the Licensed Application and the content thereof.

This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Apple Media Services Terms and Conditions ('Usage Rules'). Mehmet Can Bil Karamalli acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.

Caretta X when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Caretta X is to be used on devices that operate with Apple's operating systems ('iOS' and 'Mac OS').
...
Caretta X ('Licensed Application') is a piece of software created to provide a platform for users to discover and connect with local service providers — and customized for iOS mobile devices ('Devices'). It is used to help users find and connect with local service providers.
...
2.3  You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with Mehmet Can Bil Karamalli's prior written consent), sell, rent, lend, lease, or otherwise redistribute the Licensed Application.

2.4  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with Mehmet Can Bil Karamalli's prior written consent).
...
3.1  The Licensed Application requires a firmware version 1.0.10 or higher. Licensor recommends using the latest version of the firmware.
...
4.2  Mehmet Can Bil Karamalli and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.

### 5. USE OF DATA

You acknowledge that Licensor will be able to access and adjust Your downloaded Licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy: https://github.com/mehmetcbk/carettax-privacypolicy/blob/main/privacy_policy_en.md.
...
9.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of Mehmet Can Bil Karamalli's sphere of influence that affect the executability of the Licensed Application.

9.3  You are required to inspect the Licensed Application immediately after installing it and notify Mehmet Can Bil Karamalli about issues discovered without delay by email provided in Contact Information. The defect report will be taken into consideration and further investigated if it has been emailed within a period of ninety (90) days after discovery.

9.4  If we confirm that the Licensed Application is defective, Mehmet Can Bil Karamalli reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
...
The license is valid until terminated by Mehmet Can Bil Karamalli or by You. Your rights under this license will terminate automatically and without notice from Mehmet Can Bil Karamalli if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.

### 14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY

Mehmet Can Bil Karamalli represents and warrants that Mehmet Can Bil Karamalli will comply with applicable third-party terms of agreement when using Licensed Application.
